...
const AllSpecialDishes = () => {
  const [page, setPage] = React.useState(1);

  const { data, isLoading, error, refetch } = useQuery({
    queryKey: ["fetchAllSpecialDishes", page],
    queryFn: () => fetchAllSpecialDishes(page as number),
  });
...
export default AllSpecialDishes;
